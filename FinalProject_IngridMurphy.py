...
Name: Ingrid Murphy
Description: Final Project Code - Boston Crime Data 
...
def read_data():
    crime_data = pd.read_csv("bostoncrime2021_7000_sample.csv", usecols= ['INCIDENT_NUMBER','OFFENSE_CODE','OFFENSE_DESCRIPTION','DISTRICT','REPORTING_AREA',
